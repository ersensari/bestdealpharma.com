<template>
  <div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-1" style="border:1px solid red">col 1</div>
        <div class="col-md-2" style="border:1px solid blue">col 2</div>
        <div class="col-md-3" style="border:1px solid yellow">col 3</div>
        <div class="col-md-6" style="border:1px solid black">col 6</div>
      </div>
    </div>
  </div>
</template>
